...
const suites = ['pane-test.cjs', 'save-harness.mjs', 'trunc-harness.mjs', 'struct-harness.mjs', 'journal-harness.mjs', 'cellundo-harness.mjs', 'tabs-harness.mjs', 'kernel-harness.mjs', 'exec-harness.mjs', 'format-harness.mjs'];
let bad = 0;
